...
Since high school, computer science has piqued my curiosity. So, after high school, I took the decision to apply at \textbf{the University of AMIKOM Yogyakarta}, one of the top computer science campuses in Indonesia, for an undergraduate computer engineering degree. As an undergraduate student in computer science, I learned plenty of new information while studying at the college. Until one day, I was hired as a research assistant to gather datasets, develop object detection models, and implement programs on edge devices under the title \textbf{New Normal Adaptation Monitoring Using Multimedia Data Analysis with Deep Learning}, led by \profTwo. That is when I began my research experience.
